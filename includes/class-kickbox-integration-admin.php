...
class Kickbox_Integration_Admin {
	...
	public function __construct() {
		...
		// Standalone menu is now integrated into WooCommerce Settings > Kickbox tab
		// Keeping this commented for backward compatibility if needed
		...
		add_action( 'admin_notices', array( $this, 'show_deliverable_block_warning' ) );
	}
	...
	public function enqueue_admin_scripts( $hook ) {
		...
		// Enqueue React components (handles API key field, Allow List, Flagged Emails, and Statistics)
	...
	/**
	 * Admin page content (standalone menu page)
	 */
	...
	/**
	 * Render settings content (used by both standalone page and WC settings tab)
	 */
		...
		<form method="post" action="options.php" id="kickbox-integration-settings-form" style="display: none;">
			...
			<table class="form-table">
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_api_key"><?php echo esc_html__( 'API Key', 'kickbox-integration' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_sandbox_mode"><?php echo esc_html__( 'Sandbox Mode', 'kickbox-integration' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_enable_checkout_verification"><?php echo esc_html__( 'Checkout Verification', 'kickbox-integration' ); ?></label>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_enable_registration_verification"><?php echo esc_html__( 'Registration Verification', 'kickbox-integration' ); ?></label>
					</th>
					<td>
			...
			<table class="form-table">
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_deliverable_action"><?php echo esc_html__( 'Deliverable Emails', 'kickbox-integration' ); ?></label>
					</th>
					<td>
						<select id="kickbox_integration_deliverable_action"
										name="kickbox_integration_deliverable_action">
							<option
								value="allow" <?php selected( get_option( 'kickbox_integration_deliverable_action', 'allow' ), 'allow' ); ?>>
								<?php echo esc_html__( 'Allow checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="block" <?php selected( get_option( 'kickbox_integration_deliverable_action', 'allow' ), 'block' ); ?>>
								<?php echo esc_html__( 'Block checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="review" <?php selected( get_option( 'kickbox_integration_deliverable_action', 'allow' ), 'review' ); ?>>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_undeliverable_action"><?php echo esc_html__( 'Undeliverable Emails', 'kickbox-integration' ); ?></label>
					</th>
					<td>
						<select id="kickbox_integration_undeliverable_action"
										name="kickbox_integration_undeliverable_action">
							<option
								value="allow" <?php selected( get_option( 'kickbox_integration_undeliverable_action', 'allow' ), 'allow' ); ?>>
								<?php echo esc_html__( 'Allow checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="block" <?php selected( get_option( 'kickbox_integration_undeliverable_action', 'allow' ), 'block' ); ?>>
								<?php echo esc_html__( 'Block checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="review" <?php selected( get_option( 'kickbox_integration_undeliverable_action', 'allow' ), 'review' ); ?>>
								<?php echo esc_html__( 'Allow but flag for review', 'kickbox-integration' ); ?>
							</option>
						</select>
					</td>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_risky_action"><?php echo esc_html__( 'Risky Emails', 'kickbox-integration' ); ?></label>
					</th>
					<td>
						<select id="kickbox_integration_risky_action" name="kickbox_integration_risky_action">
							<option
								value="allow" <?php selected( get_option( 'kickbox_integration_risky_action', 'allow' ), 'allow' ); ?>>
								<?php echo esc_html__( 'Allow checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="block" <?php selected( get_option( 'kickbox_integration_risky_action', 'allow' ), 'block' ); ?>>
								<?php echo esc_html__( 'Block checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="review" <?php selected( get_option( 'kickbox_integration_risky_action', 'allow' ), 'review' ); ?>>
								<?php echo esc_html__( 'Allow but flag for review', 'kickbox-integration' ); ?>
							</option>
						</select>
					</td>
				...
				<tr>
					<th scope="row">
						<label
							for="kickbox_integration_unknown_action"><?php echo esc_html__( 'Unknown Emails', 'kickbox-integration' ); ?></label>
					</th>
					<td>
						<select id="kickbox_integration_unknown_action" name="kickbox_integration_unknown_action">
							<option
								value="allow" <?php selected( get_option( 'kickbox_integration_unknown_action', 'allow' ), 'allow' ); ?>>
								<?php echo esc_html__( 'Allow checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="block" <?php selected( get_option( 'kickbox_integration_unknown_action', 'allow' ), 'block' ); ?>>
								<?php echo esc_html__( 'Block checkout', 'kickbox-integration' ); ?>
							</option>
							<option
								value="review" <?php selected( get_option( 'kickbox_integration_unknown_action', 'allow' ), 'review' ); ?>>
								<?php echo esc_html__( 'Allow but flag for review', 'kickbox-integration' ); ?>
							</option>
						</select>
					</td>
	...
	public function show_balance_notice() {
		...
		<div class="notice notice-warning is-dismissible">
			...
			<p>
				...
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=kickbox' ) ); ?>"
	...
	/**
	 * Show admin notice when deliverable action is set to block
	 */
	public function show_deliverable_block_warning() {
		// Only show to users who can manage WooCommerce
		if ( ! current_user_can( 'manage_woocommerce' ) ) {
			return;
		}

		$deliverable_action = get_option( 'kickbox_integration_deliverable_action', 'allow' );

		if ( $deliverable_action === 'block' ) {
			$settings_url = admin_url( 'admin.php?page=wc-settings&tab=kickbox&section=actions' );
			?>
			<div class="notice notice-warning is-dismissible">
				<p>
					<strong><?php esc_html_e( 'Kickbox Integration Warning:', 'kickbox-integration' ); ?></strong>
					<?php
					echo esc_html__(
						'Deliverable emails are currently being blocked. This will block customer checkout and account signups and is generally not recommended.',
						'kickbox-integration'
					);
					?>
					<a href="<?php echo esc_url( $settings_url ); ?>">
						<?php esc_html_e( 'Change this setting', 'kickbox-integration' ); ?>
					</a>
				</p>
			</div>
			<?php
